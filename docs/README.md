...
- [`guides/review-feedback-and-anti-ai-scan.md`](./guides/review-feedback-and-anti-ai-scan.md)：审查教训库自更新 & 确定性反 AI 扫描
- [`guides/arc-planning.md`](./guides/arc-planning.md)：小卷（故事弧）规划层 — 卷内场景/人物规划 + 写前注入
